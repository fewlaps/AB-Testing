...
public class ABBTestingAndroidShould {
    ...
    public void alwaysReturnSameExperimentOption() {
        ...
        ABBTestingAndroid.init(RuntimeEnvironment.application, experiments);

        String firstOption = ABBTestingAndroid.getCurrentOptionFor(EXPERIMENT_NAME);
        System.out.println("Old option: " + firstOption);
        for (int i = 0; i < 10; i++) {
            String newOption = ABBTestingAndroid.getCurrentOptionFor("experiment");
